...
extension Color {
    ...
    static let ShishiColorPanelBackground = Color(.white)
...
extension Image {
    func helpPictures() -> some View {
        self
            .resizable().scaledToFill().frame(width: 220)
            .clipShape(.rect(cornerRadius: 15)).shadow(radius: 2, x: 1, y: 2)
...
extension Text {
    func warningTextLarge() -> some View {
        self
            .font(.body).foregroundStyle(Color.ShishiColorRed_)
            .padding(.vertical, 1)
    }
}
...
extension Text {
    func ueberschriftLarge() -> some View {
        self
            .font(.largeTitle).foregroundStyle(Color.ShishiColorBlack)
...
extension Text {
    func ueberschriftLargeBold() -> some View {
        self
            .font(.largeTitle).bold().foregroundStyle(Color.ShishiColorBlack)
            .padding(.horizontal, 20).padding(.vertical, 1)
    }
}
...
extension Text {
    func ueberschriftenText() -> some View {
        self
            .font(.title3).foregroundStyle(Color.black)
            .padding(.horizontal, 20).padding(.vertical, 1)
    }
}
...
extension Text {
    func ueberschriftenTextBold() -> some View {
        self
            .font(.title3).bold().foregroundStyle(Color.black)
            .padding(.horizontal, 20).padding(.vertical, 1)
    }
}
...
extension Text {
    func normalerText() -> some View {
        self
            .font(.callout).foregroundStyle(Color.ShishiColorBlack)
...
extension Text {
    func normalerTextBold() -> some View {
        self
            .font(.callout).bold().foregroundStyle(Color.ShishiColorBlack)
            .padding(.horizontal, 20).padding(.vertical, 2)
    }
}
...
extension Text {
    func panelText() -> some View {
        self
            .font(.footnote).foregroundStyle(Color.ShishiColorBlack)
            .padding(.horizontal, 1).padding(.vertical, 0.1)
    }
}
...
extension Text {
    func textFieldAlsText() -> some View {
        self
            ...
            .padding(.horizontal, 20).padding(.vertical, 10)
            .background(RoundedRectangle(cornerRadius: 8).stroke(Color.ShishiColorGray, lineWidth: 1 ))
...
extension TextEditor {
    func customTextFieldNotes() -> some View {
        self
            ...
            .textEditorStyle(.plain).multilineTextAlignment(.leading)
    }
}
...
extension TextField {
    func customTextField() -> some View {
        self
            .frame(height: 20, alignment: .leading).textFieldStyle(.plain)
            .padding(.horizontal, 20).padding(.vertical, 10)
            .background(RoundedRectangle(cornerRadius: 8).stroke(Color.ShishiColorGray, lineWidth: 1 ))
            .disableAutocorrection(true).textInputAutocapitalization(.never)
            .padding(0.5)
...
extension Text {
    func customTextFieldTextLow() -> some View {
        self
            .font(.caption).foregroundStyle(Color.ShishiColorDarkGray)
...
extension Text {
    func customTextFieldTextMid() -> some View {
        self
            .font(.caption2).foregroundStyle(Color.ShishiColorDarkGray)
            .padding(.horizontal, 20)
    }
}
...
extension TextField {
    func customPasswordField() -> some View {
        self
            .frame(height: 20).textFieldStyle(.plain)
            .padding(.horizontal, 20).padding(.vertical, 10)
            .background(RoundedRectangle(cornerRadius: 8).stroke(Color.ShishiColorGray, lineWidth: 1))
            .disableAutocorrection(true).textInputAutocapitalization(.never)
            .padding(0.5)
